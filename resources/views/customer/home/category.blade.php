...
<div class="container">
    ...
    <div class="row">
        @if($products->isEmpty())
        <div class="col-12">
            <p class="text-center flex-grow-1">Tidak ada produk pada kategori ini.</p>
        </div>
        @else
            ...
            <div class="modal-body">
                <form id="rentalForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="total_before_discount" name="total_before_discount"
                            readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="total_discounted" name="total_discounted" readonly>
                    </div>
